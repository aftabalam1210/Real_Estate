...
st.image("https://upload.wikimedia.org/wikipedia/commons/d/d6/Cyber_City_View.jpg", caption="Gurugram's Dynamic Real Estate Landscape", use_container_width=True)
